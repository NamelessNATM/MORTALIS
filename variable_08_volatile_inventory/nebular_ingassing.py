...
# Note 118: k_H = 0.419 ppm/bar — Henry's Law for H2 in peridotitic melt. Lab measurement. Earth fallback.
# Note 119: f_env coefficient 1.06e-5 — Ikoma & Genda (2006). Solar-analog calibration. Earth fallback.
# Note 120: t_disk = 5×(M_star/M_☉)^−0.5 Myr — Mamajek (2009), Ribas et al. (2015).
#           Multi-stellar empirical fit. Model applicability limit at extreme stellar masses.
# Note 131: FeO supply treated as non-limiting. 8 wt% FeO assumed. FeO content not a cascade variable.
#           Earth fallback.
# Note 132: Equilibrium dissolution assumed. Convective mixing timescale (days) << disk lifetime (Myr).
...
M_SUN_KG = 1.989e30
M_EARTH_KG = 5.972e24
K_H_PPM_BAR = 0.419  # ⚠️ Note 118
F_ENV_COEFF = 1.06e-5  # ⚠️ Note 119
T_DISK_SOLAR_MYR = 5.0  # Myr at 1 M_sun — Note 120
T_DISK_EXPONENT = -0.5  # stellar mass scaling — Note 120
