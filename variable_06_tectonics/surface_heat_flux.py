...
#     Nu  = A_mob * Ra^(1/3)                           [mobile approximation, Note 64]
#     q_s = k * DeltaT / D * Nu
#
...
#   Within the numerically established range 0.1-0.2. Note 62.
#
...
#   Earth is not a stagnant lid planet. Note 63.
#
...
#   transitional scaling implemented. Note 64.
#
...
_A_P = 0.50  # stagnant lid prefactor [dimensionless] — ⚠️ EARTH FALLBACK Note 63
_A_MOB = 0.122  # mobile/sluggish lid prefactor [dimensionless] — ⚠️ EARTH FALLBACK Note 62
...
def compute_nusselt(
    ...
    if tectonic_regime == "stagnant_lid":
        ...
        # mobile_lid or sluggish_lid (Note 64: sluggish uses mobile approximation)
